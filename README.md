...
| -------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. Registro de Actividades             | El fragmento `CrearTareaFragment `aloja el formulario de registro.                                                                                                                                                                            |
| 2. Listado Dinámico                    | El fragmento `VerTareasFragment ` usa un **`RecyclerView`** con **`TaskAdapter`** . La actualización es **reactiva** a través de la observación de `TaskViewModel.allTasks` (LiveData)                                                        |
